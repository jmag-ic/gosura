...
func TestSQLParseHook_Aggregates(t *testing.T) {
	tests := []sql.SQLParseTestCase{
		...
		},
		{
			...
			ExpectedWhere:      "",
			ExpectedAggregates: `AVG("rating") AS avg_rating, COUNT(*) AS count, MAX("price") AS max_price`,
			Params:             []any{},
		},
		{
		...
		},
		{
			...
			ExpectedWhere:      "",
			ExpectedAggregates: `AVG("price") AS avg_price, COUNT(*) AS count`,
		...
		},
		{
			...
			ExpectedWhere:      "",
			ExpectedAggregates: `AVG("rating") AS avg_rating, COUNT(*) AS count, MAX("created_at") AS max_created_at, MIN("stock") AS min_stock, SUM("price") AS sum_price`,
			Params:             []any{},
		},
		{
